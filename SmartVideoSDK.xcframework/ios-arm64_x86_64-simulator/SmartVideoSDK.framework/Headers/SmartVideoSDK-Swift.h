...
#ifndef SMARTVIDEOSDK_SWIFT_H
#define SMARTVIDEOSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SmartVideoSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13SmartVideoSDK19BroadcastSenderBase")
@interface BroadcastSenderBase : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC13SmartVideoSDK11ChatMessage")
@interface ChatMessage : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC13SmartVideoSDK4File")
...
@class NSStream;
SWIFT_CLASS("_TtC13SmartVideoSDK19FoundationTransport")
...
SWIFT_CLASS("_TtC13SmartVideoSDK16GenesysAgentInfo")
...
@class NSString;
@class NSData;
SWIFT_CLASS("_TtC13SmartVideoSDK12NativeEngine") SWIFT_AVAILABILITY(tvos,introduced=13.0) SWIFT_AVAILABILITY(watchos,introduced=6.0) SWIFT_AVAILABILITY(ios,introduced=13.0) SWIFT_AVAILABILITY(macos,introduced=10.15)
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC13SmartVideoSDK14OutgoingCallVC")
...
typedef SWIFT_ENUM(NSInteger, SmartVideoCallStatus, open) {
  ...
  SmartVideoCallStatusCallHangUp = 5,
  SmartVideoCallStatusCallFinished = 6,
};

SWIFT_ENUM_FWD_DECL(NSInteger, SmartVideoChatStatus)
@class SmartVideoError;
SWIFT_PROTOCOL("_TtP13SmartVideoSDK22SmartVideoChatDelegate_")
...
SWIFT_PROTOCOL("_TtP13SmartVideoSDK18SmartVideoDelegate_")
...
SWIFT_CLASS("_TtC13SmartVideoSDK15SmartVideoError")
