...
Pod::Spec.new do |spec|
  ...
  spec.authors = { 'VideoEngager' => 'contact@videoengager.com' }
 ...
 # =========================
  # SUBSPEC: COBROWSE
  # =========================
  spec.subspec 'Cobrowse' do |c|
    c.dependency 'CobrowseIO'

    # само 1 файл
    c.source_files = 'Sources/CoBrowse/CoBrowseEngine.swift'
  end
